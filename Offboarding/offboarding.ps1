<############################################################################################################
# Offboarding Script V2.5

##  This script assists SBS with the Offboarding Process, and processes the AD account
##  Avi Gondker - 2024

# Actions :
# Asks for Username as input and checks the account exists
# Disable the account
# Set Account Expiry Date
# Moves the account to the Leavers or Holding OUs
# Clears the Leavers manager
# Strip all AD groups from the account (will remove File and mailbox access, and Group Based Licensing)
# Add the relevant info to the leavers description on the account's properties page

## Suggestions for developments :
# Implement GUI - enabled users to enter username and ticket ref   DONE
# Implement a tick box for "Holding" - will then move to Holding and add additional/different notes etc? DONE

# # MLF Bulk Password Reset Utility V1.1
# This script resets all MLF account passwords and adds the students to the SBS-LG-Exchange_Online_for_Alumni to license the mailbox
# Avi Gondker 2023

# Revisions
# 22/06/23 - V1 - First Draft
# 03/07/23 - v1.1 - Enable "Change password at next login"
...
{
$importfile = Get-FileName "\\sbs.ox.ac.uk\groupshares$\Staff_IT\SDP Project\"
...
#This section resets the passwords on all the listed accounts, and adds them to the relevant AD group for licensing
...
try {
       ...
       $progressBar.PerformStep()                                     
        ...
        $global:ErrorLog += $user.username + " FAILED - AD object does not exist, password NOT reset"
        $global:f++
        $count++
        $progressBar.PerformStep()                                
       }
...
Function Get-FileName($initialDirectory, $filter)
{
    ...
    $OpenFileDialog.Title = "Please select your List of accounts as .csv import file"
